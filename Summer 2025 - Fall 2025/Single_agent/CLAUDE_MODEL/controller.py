...
log_dir = f"/home/devika/Desktop/MORE_project/Deadlock_Resolution/Deadlock-Resolution-using-Foundation-Models/Single_agent/CLAUDE_MODEL/logs/{folder_name}/"
log_file_path = os.path.join(log_dir, "path_data.xlsx")
...
waypoints = [np.array(p) for p in ast.literal_eval(df.loc[0, "Final Waypoints"])]
dt = 0.1
k = 1.0
threshold = 0.1
